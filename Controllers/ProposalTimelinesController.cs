...
[ApiController]
[Route("[controller]")]
public class ProposalTimelinesController : ControllerBase
{
    private readonly ILogger<ProposalTimelinesController> _logger;

    public ProposalTimelinesController(ILogger<ProposalTimelinesController> logger)
    {
        _logger = logger;
    }
    ...
    public IActionResult Get(uint SemesterId)
    {
        ...
        var timelines = from t in db.ProposalTimeline
